...
# Photo: fills arch perfectly
photo_tag = (
    f'''<img src="data:image/jpeg;base64,{photo_b64}"
        style="position:absolute;bottom:0;left:50%;transform:translateX(-50%);
        width:278px;height:360px;object-fit:cover;object-position:top center;
        border-radius:160px 160px 0 0;display:block;" />'''
    if photo_b64 else
    '''<div style="position:absolute;bottom:0;left:50%;transform:translateX(-50%);
       width:278px;height:360px;border-radius:160px 160px 0 0;overflow:hidden;
       background:linear-gradient(160deg,rgba(124,58,237,0.4),rgba(59,130,246,0.3));
       display:flex;flex-direction:column;align-items:center;justify-content:center;
       color:rgba(255,255,255,0.5);font-size:0.7rem;gap:0.5rem;text-align:center;">
       <span style="font-size:3.5rem;">👩</span><p>Taruh profile.jpg</p></div>'''
)
...
:root {
  ...
  --brown:#6B3F2A; --brown2:#8B5E3C;
}
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
html,body,[class*="css"],[data-testid="stAppViewContainer"]{font-family:'DM Sans',sans-serif !important;}
...
/* ══ NAV ══ */
.navbar{position:sticky;top:0;z-index:999;background:rgba(255,255,255,0.94);backdrop-filter:blur(20px);border-bottom:1px solid rgba(124,58,237,0.1);display:flex;justify-content:space-between;align-items:center;padding:0 6%;height:62px;}
.nav-logo{font-family:'Cormorant Garamond',serif;font-size:1.1rem;font-weight:600;color:var(--purple);letter-spacing:0.05em;}
.nav-links a{font-size:0.68rem;letter-spacing:0.14em;text-transform:uppercase;color:var(--muted);text-decoration:none;margin-left:1.75rem;}
...
.hero{
  ...
  align-items:center;gap:2rem;padding:5.5rem 6% 3.5rem;
  position:relative;overflow:hidden;
}
.hero::before{content:'';position:absolute;width:480px;height:480px;border-radius:50%;background:radial-gradient(circle,rgba(124,58,237,0.30) 0%,transparent 70%);top:-100px;left:-80px;pointer-events:none;}
.hero::after{content:'';position:absolute;width:360px;height:360px;border-radius:50%;background:radial-gradient(circle,rgba(236,72,153,0.22) 0%,transparent 70%);bottom:-60px;right:-60px;pointer-events:none;}
.hero-left{position:relative;z-index:1;}
.hero-pill{display:inline-flex;align-items:center;gap:0.5rem;font-size:0.68rem;letter-spacing:0.15em;text-transform:uppercase;color:var(--purple-lt);border:1.5px solid rgba(167,139,250,0.35);padding:0.4rem 1rem;border-radius:20px;margin-bottom:1.5rem;background:rgba(255,255,255,0.06);}
.hero-dot{display:inline-block;width:7px;height:7px;border-radius:50%;background:#6EE7B7;box-shadow:0 0 7px #6EE7B7;}
.hero-name{font-family:'Cormorant Garamond',serif;font-size:clamp(3rem,5.5vw,5rem);font-weight:700;line-height:1.05;color:#fff;margin-bottom:0.75rem;}
.hero-name em{font-style:italic;font-weight:400;background:linear-gradient(135deg,#C084FC,#F472B6,#60A5FA);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;}
.hero-tagline{font-size:0.77rem;letter-spacing:0.13em;text-transform:uppercase;color:rgba(255,255,255,0.42);margin-bottom:2rem;line-height:2;}
.hero-btns{display:flex;gap:0.75rem;flex-wrap:wrap;margin-bottom:2rem;}

.btn-fill{display:inline-block;padding:0.78rem 1.8rem;background:linear-gradient(135deg,var(--purple),var(--pink));color:#fff !important;font-size:0.71rem;font-weight:500;letter-spacing:0.12em;text-transform:uppercase;border-radius:4px;text-decoration:none !important;box-shadow:0 4px 20px rgba(124,58,237,0.40);}
.btn-ghost{display:inline-block;padding:0.78rem 1.8rem;border:1.5px solid rgba(255,255,255,0.22);color:rgba(255,255,255,0.82) !important;font-size:0.71rem;font-weight:500;letter-spacing:0.12em;text-transform:uppercase;border-radius:4px;text-decoration:none !important;background:rgba(255,255,255,0.06);}
.btn-cv{display:inline-flex;align-items:center;gap:0.45rem;padding:0.78rem 1.5rem;border:1.5px solid rgba(255,255,255,0.20);color:rgba(255,255,255,0.78) !important;font-size:0.71rem;font-weight:500;letter-spacing:0.12em;text-transform:uppercase;border-radius:4px;text-decoration:none !important;background:rgba(255,255,255,0.07);}

.hero-stats{display:flex;gap:1.1rem;flex-wrap:wrap;}
.stat{text-align:center;background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.12);border-radius:12px;padding:0.8rem 1.3rem;}
.stat-num{font-family:'Cormorant Garamond',serif;font-size:1.55rem;font-weight:700;background:linear-gradient(135deg,#C084FC,#F472B6);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;line-height:1;}
.stat-lbl{font-size:0.58rem;letter-spacing:0.13em;text-transform:uppercase;color:rgba(255,255,255,0.35);margin-top:0.2rem;}

/* ══ HERO PHOTO FRAME ══ */
.hero-right{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:1.75rem;position:relative;z-index:1;}
.hero-photo-wrap{position:relative;width:300px;height:380px;flex-shrink:0;}
.hero-photo-bg{
  position:absolute;inset:0;border-radius:180px 180px 0 0;
  background:linear-gradient(160deg,rgba(124,58,237,0.60),rgba(236,72,153,0.45));
  box-shadow:0 0 80px rgba(124,58,237,0.55),0 0 140px rgba(236,72,153,0.28);
  overflow:hidden;
}

/* ══ SECTIONS ══ */
.section{padding:6.5rem 6%;}
.sec-about{background:#fff8f9;background-image:radial-gradient(ellipse 70% 55% at 5% 10%,rgba(251,207,232,0.70) 0%,transparent 55%),radial-gradient(ellipse 60% 50% at 95% 90%,rgba(221,214,254,0.60) 0%,transparent 55%);}
.sec-skills{background:#0f172a;background-image:radial-gradient(ellipse 75% 55% at 15% 25%,rgba(99,102,241,0.40) 0%,transparent 60%),radial-gradient(ellipse 60% 50% at 85% 75%,rgba(20,184,166,0.35) 0%,transparent 55%);}
.sec-exp{background:#fffbf5;background-image:radial-gradient(ellipse 70% 55% at 90% 10%,rgba(253,186,116,0.50) 0%,transparent 55%),radial-gradient(ellipse 55% 45% at 5% 85%,rgba(251,207,232,0.55) 0%,transparent 55%);}
.sec-projects{background:#0a1628;background-image:radial-gradient(ellipse 70% 55% at 80% 15%,rgba(20,184,166,0.35) 0%,transparent 58%),radial-gradient(ellipse 60% 45% at 10% 80%,rgba(59,130,246,0.30) 0%,transparent 55%);}
.sec-education{background:#f5f3ff;background-image:radial-gradient(ellipse 65% 50% at 0% 0%,rgba(221,214,254,0.80) 0%,transparent 55%),radial-gradient(ellipse 60% 50% at 100% 100%,rgba(199,210,254,0.70) 0%,transparent 55%);}
.sec-contact{background:#08051a;background-image:radial-gradient(ellipse 70% 55% at 20% 20%,rgba(124,58,237,0.45) 0%,transparent 60%),radial-gradient(ellipse 60% 50% at 85% 80%,rgba(236,72,153,0.30) 0%,transparent 55%);}
...
/* Section titles — BROWN for light sections, white for dark */
...
.t-brown{color:var(--brown) !important;}
.t-l{color:#fff;}
...
/* Experience */
.exp-card{display:flex;gap:1.5rem;align-items:flex-start;background:rgba(255,255,255,.88);border:1px solid rgba(245,158,11,.18);border-radius:16px;padding:1.75rem;margin-bottom:1.25rem;box-shadow:0 2px 12px rgba(245,158,11,.07);}
...
<div class="section sec-about" id="about">
  ...
  <h2 class="sec-title t-brown">Who I Am</h2>
...
<div class="section sec-exp" id="experience">
  ...
  <h2 class="sec-title t-brown">Work History</h2>
  <div class="divider"><div class="dl dl-d"></div><div class="dg dg-p"></div><div class="dl dl-d"></div></div>
...
<div class="section sec-education" id="education">
  ...
  <h2 class="sec-title t-brown">Academic Background</h2>
  <div class="divider"><div class="dl dl-d"></div><div class="dg dg-p"></div><div class="dl dl-d"></div></div>
